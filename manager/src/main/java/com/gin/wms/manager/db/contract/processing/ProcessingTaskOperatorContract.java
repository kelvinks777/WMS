...
public class ProcessingTaskOperatorContract extends OperatorBaseContract {
    public static final String TABLE_NAME = "processing_task_operator";

    public ProcessingTaskOperatorContract() throws Exception {
        super();
    }
